...
public class ArrayTest {
    ...
    public void should_get_array() throws Exception {
        final Toml toml = new Toml().read("list = [\"a\", \"b\", \"c\"]");
    ...
    public void should_allow_multiline_array() throws Exception {
        final Toml toml = new Toml().read(this.file("should_allow_multiline_array"));
    ...
    public void should_get_nested_arrays() throws Exception {
        final Toml clients = new Toml().read("data = [ [\"gamma\", \"delta\"], [1, 2]] # just an update to make sure parsers support it");
    ...
    public void should_get_deeply_nested_arrays() throws Exception {
        final List<List<?>> data = new Toml().read("data = [[[1], [2]], [3, 4]]").getList("data");
    ...
    public void should_ignore_comma_at_end_of_array() throws Exception {
        final Toml toml = new Toml().read("key=[1,2,3,]");
    ...
    public void should_support_mixed_string_types() throws Exception {
        final Toml toml = new Toml().read("key = [\"a\", 'b', \"\"\"c\"\"\", '''d''']");
    ...
    public void should_support_array_of_inline_tables() throws Exception {
        final Toml toml = new Toml().read(this.getClass().getResourceAsStream("should_support_array_of_inline_tables.toml"));
    ...
    private File file(String file) {
        return Utils.file(this.getClass(), file);
    }
}
